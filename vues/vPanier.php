...
<?php
 ...
 ?>     
        <tr>
              <td align="center"><img class="img-polaroid" src="../images/<?php echo $fleur[$i]["image"]?>" /></td>
            <td><?php echo $fleur[$i]["ref"]?></td>
            <td><?php echo $fleur[$i]["designation"]?></td>
           <td><?php echo $fleur[$i]["prix"]?></td>
          <?php   
           if (estConnecteClient()==true)
           {
           ?>
           <td><a href ="lister.php?reference=<?php echo $fleur[$i]["ref"]?>" > retirer du panier </a></td>
           <?php   
           }  
           ?>
<?php
